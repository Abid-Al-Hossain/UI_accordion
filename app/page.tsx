...
export default function Page() {
  const [state, setState] = useState<AccordionState>(DEFAULT_ACCORDION_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Accordion Studio" controls={controls} preview={output} /></AppShell>;
}
