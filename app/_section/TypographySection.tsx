...
export default function TypographySection({ state, update }: Props) {
  return <SectionCard title="Typography" subtitle="Typography controls for native accordion generation."><FontFamilySelect value={state.fontFamily} onChange={(value) => update("fontFamily", value)} />
